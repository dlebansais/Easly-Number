namespace TestEaslyNumber2
{
    ...
    public partial class TestNumber
    {
        ...
        public static void TestDoubleToString()
        {
            ...
            using Stream TestDataStream = CurrentAssembly.GetManifestResourceStream("TestEaslyNumber.New.DoubleOutput.txt")!;
        ...
        public static void TestSingleToString()
        {
            ...
            Assembly CurrentAssembly = Assembly.GetExecutingAssembly();
            using Stream TestDataStream = CurrentAssembly.GetManifestResourceStream("TestEaslyNumber.New.SingleOutput.txt")!;
            using StreamReader Reader = new StreamReader(TestDataStream);
