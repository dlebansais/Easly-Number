...
#pragma warning disable SA1601 // Partial elements should be documented
    internal static partial class NativeMethods
    {
        ...
        public delegate float __mpfr_get_flt(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate double __mpfr_get_d(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate long __mpfr_get_si(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate ulong __mpfr_get_ui(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_get_sj(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate uint __mpfr_get_uj(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate double __mpfr_get_d_2exp(out long exp, ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_get_z(ref __mpz_t rop, ref __mpfr_t op, Rounding rnd);
        ...
        */
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate void __mpfr_get_str(StringBuilder str, out int expptr, int _base, ulong n, ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_fits_ulong_p(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_fits_slong_p(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_fits_uint_p(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_fits_sint_p(ref __mpfr_t op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_fits_ushort_p(ref __mpfr_t op, Rounding rnd);
