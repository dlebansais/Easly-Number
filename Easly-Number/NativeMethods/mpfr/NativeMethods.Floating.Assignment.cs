...
#pragma warning disable SA1601 // Partial elements should be documented
    internal static partial class NativeMethods
    {
        ...
        public delegate int __mpfr_set(ref __mpfr_t rop, ref __mpfr_t op, Rounding rnd);
        public static __mpfr_set mpfr_set { get; } = Marshal.GetDelegateForFunctionPointer<__mpfr_set>(GetMpfrPointer(nameof(mpfr_set)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_ui(ref __mpfr_t rop, ulong op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_si(ref __mpfr_t rop, long op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_uj(ref __mpfr_t rop, uint op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_sj(ref __mpfr_t rop, int op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_flt(ref __mpfr_t rop, float op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_d(ref __mpfr_t rop, double op, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_ui_2exp(ref __mpfr_t rop, ulong op, long e, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_si_2exp(ref __mpfr_t rop, long op, long e, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_uj_2exp(ref __mpfr_t rop, uint op, long e, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_sj_2exp(ref __mpfr_t rop, int op, long e, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_set_z_2exp(ref __mpfr_t rop, ref __mpfr_t op, long e, Rounding rnd);
        ...
        public delegate int __mpfr_set_str(ref __mpfr_t rop, string str, uint strbase, Rounding rnd);
