...
#pragma warning disable SA1601 // Partial elements should be documented
    internal static partial class NativeMethods
    {
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_min(ref __mpfr_t rop, ref __mpfr_t op1, ref __mpfr_t op2, Rounding rnd);
        public static __mpfr_min mpfr_min { get; } = Marshal.GetDelegateForFunctionPointer<__mpfr_min>(GetMpfrPointer(nameof(mpfr_min)));

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_max(ref __mpfr_t rop, ref __mpfr_t op1, ref __mpfr_t op2, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_urandom(ref __mpfr_t rop, ref __gmp_randstate_t state, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_nrandom(ref __mpfr_t rop1, ref __gmp_randstate_t state, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_grandom(ref __mpfr_t rop1, ref __mpfr_t rop2, ref __gmp_randstate_t state, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_erandom(ref __mpfr_t rop1, ref __gmp_randstate_t state, Rounding rnd);
        ...
        */
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_setsign(ref __mpfr_t rop, ref __mpfr_t op, int s, Rounding rnd);
        ...
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate int __mpfr_copysign(ref __mpfr_t rop, ref __mpfr_t op1, ref __mpfr_t op2, Rounding rnd);
